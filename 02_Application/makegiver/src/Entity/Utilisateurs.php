...
class Utilisateurs implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private bool $accepte_contact_public = false;

    #[ORM\Column(name: 'Date_Inscription', type: 'datetime')]
    private ?\DateTimeInterface $dateInscription = null;

    #[ORM\Column(name: 'pseudo', length: 255, nullable: true)]
    ...
    public function isAccepteContactPublic(): bool { return $this->accepte_contact_public; }
    public function setAccepteContactPublic(bool $val): static { $this->accepte_contact_public = $val; return $this; }
